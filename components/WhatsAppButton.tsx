...
export default function WhatsAppButton({ message }: { message?: string }) {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex items-center gap-2 rounded-full bg-[#25D366] text-white pl-4 pr-5 py-3 shadow-lg shadow-black/15 font-mono text-sm font-medium"
    >
