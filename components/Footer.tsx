...
function SocialIcon({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="h-9 w-9 rounded-full border border-border flex items-center justify-center text-text-muted hover:text-teal hover:border-teal/40 hover:bg-teal/5 transition-all duration-200"
    >
      {children}
    </a>
  );
  ...
  return (
    <footer id="contact" className="mt-24">
      <div className="mx-4 sm:mx-8 lg:mx-auto lg:max-w-7xl">
        <div className="rounded-2xl border border-border bg-paper-card px-8 py-12 text-center relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-wash/80 via-transparent to-teal/5 pointer-events-none" />
          <p className="relative font-mono text-xs uppercase tracking-widest text-teal mb-4">
            Ready when you are
          </p>
          <h2 className="relative font-display text-2xl sm:text-3xl font-bold text-text mb-3">
            Stop stressing about your final year project
          </h2>
          <p className="relative text-text-muted text-sm max-w-md mx-auto mb-8 leading-relaxed">
      ...
      <div className="border-t border-border bg-paper-raised mt-16">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 py-16">
          ...
          <div className="mt-14 pt-8 border-t border-border">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <p className="text-xs text-text-faint">Made in India</p>
            </div>
          </div>
        </div>
      </div>
