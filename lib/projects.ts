...
export const projects: Project[] = [
  ...
  // ─── MERN Stack Projects ─────────────────────────────────────────────────
  {
    ...
    tagline: "Full-stack library system with role-based access, book loans, and a real audit trail.",
    description:
  ...
  },
  {
    ...
    tagline: "Room booking with live availability checks, automatic rate calculation, and guest self-service.",
    description:
  ...
  },
  {
    ...
    tagline: "Order management with dine-in table tracking, live price calculation, and kitchen status flow.",
    description:
  ...
  },
  {
    ...
    tagline: "Fleet dispatch with real-time vehicle availability, driver assignment, and trip lifecycle tracking.",
    description:
